...
void Test_Grid()
{
    ...
    grid.WriteFrametoCsv(0,E,Fx,Fy,one,0,directoryPath,"grid");
    cout << "------------------------------------------------------------" << endl << endl;
}
...
void Test_Metric()
{
    ...
    cout << "---------- Cartesian Tests ----------" << endl;
    {
        ...
        std::filesystem::path currentPath = std::filesystem::current_path();
	    std::string directoryPath = currentPath/"output";
        grid.WriteFrametoCsv(0, metric.g00_ll, metric.g11_ll, metric.g22_ll, metric.g00_ll, 0, directoryPath, "metric_Cart0");
        grid.WriteFrametoCsv(0, metric.g01_ll, metric.g02_ll, metric.g12_ll, metric.g01_ll, 0, directoryPath, "metric_Cart1");
        grid.WriteFrametoCsv(0, metric.tetrad00_ul, metric.tetrad11_ul, metric.tetrad22_ul, metric.tetrad00_ul, 0, directoryPath, "tetrad_Cart0");
        grid.WriteFrametoCsv(0, metric.tetrad10_ul, metric.tetrad20_ul, metric.tetrad21_ul, metric.tetrad10_ul, 0, directoryPath, "tetrad_Cart1");
    }
    cout << "-------------------------------------" << endl;
    ...
    cout << "------------ Polar Tests ------------" << endl;
    {
        ...
        std::filesystem::path currentPath = std::filesystem::current_path();
	    std::string directoryPath = currentPath/"output";
        grid.WriteFrametoCsv(0,metric.g00_ll,metric.g11_ll, metric.g22_ll,metric.g12_ll,0,directoryPath,"metric_Polar");
    }
    cout << "-------------------------------------" << endl;
    cout << "------------------------------------------------------------" << endl << endl;
}

...
public:
    ...
    {
        data[0] = tt; data[1] = tx; data[2] = ty;
        data[3] = xt; data[4] = xx; data[5] = xy;
        data[6] = yt; data[7] = yx; data[8] = yy;
    }
...
public:
    ...
    Tensor2x2x2
    (double xxx, double xxy,
     double xyx, double xyy,
        double yxx, double yxy,
        double yyx, double yyy)
    {
        data[0] = xxx; data[1] = xxy;
        data[2] = xyx; data[3] = xyy;
        data[4] = yxx; data[5] = yxy;
        data[6] = yyx; data[7] = yyy;
    }
...
public:
    ...
    // Constructors:
    Tensor3x3x3
    (double ttt, double ttx, double tty,
    ...
    {
        data[ 0] = ttt; data[ 1] = ttx; data[ 2] = tty;
        data[ 3] = txt; data[ 4] = txx; data[ 5] = txy;
        data[ 6] = tyt; data[ 7] = tyx; data[ 8] = tyy;
        data[ 9] = xtt; data[10] = xtx; data[11] = xty;
        data[12] = xxt; data[13] = xxx; data[14] = xxy;
        data[15] = xyt; data[16] = xyx; data[17] = xyy;
        data[18] = ytt; data[19] = ytx; data[20] = yty;
        data[21] = yxt; data[22] = yxx; data[23] = yxy;
        data[24] = yyt; data[25] = yyx; data[26] = yyy;
    }

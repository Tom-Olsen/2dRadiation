...
{
    // Metrik Data:
    g00_ll.resize(grid.nxy);    g00_uu.resize(grid.nxy);
    g01_ll.resize(grid.nxy);    g01_uu.resize(grid.nxy);
    g02_ll.resize(grid.nxy);    g02_uu.resize(grid.nxy);
    g11_ll.resize(grid.nxy);    g11_uu.resize(grid.nxy);
    g12_ll.resize(grid.nxy);    g12_uu.resize(grid.nxy);
    g22_ll.resize(grid.nxy);    g22_uu.resize(grid.nxy);
    d0_g00_lll.resize(grid.nxy);    d1_g00_lll.resize(grid.nxy);    d2_g00_lll.resize(grid.nxy);
    d0_g01_lll.resize(grid.nxy);    d1_g01_lll.resize(grid.nxy);    d2_g01_lll.resize(grid.nxy);
    d0_g02_lll.resize(grid.nxy);    d1_g02_lll.resize(grid.nxy);    d2_g02_lll.resize(grid.nxy);
    d0_g11_lll.resize(grid.nxy);    d1_g11_lll.resize(grid.nxy);    d2_g11_lll.resize(grid.nxy);
    d0_g12_lll.resize(grid.nxy);    d1_g12_lll.resize(grid.nxy);    d2_g12_lll.resize(grid.nxy);
    d0_g22_lll.resize(grid.nxy);    d1_g22_lll.resize(grid.nxy);    d2_g22_lll.resize(grid.nxy);
    d0_g00_luu.resize(grid.nxy);    d1_g00_luu.resize(grid.nxy);    d2_g00_luu.resize(grid.nxy);
    d0_g01_luu.resize(grid.nxy);    d1_g01_luu.resize(grid.nxy);    d2_g01_luu.resize(grid.nxy);
    d0_g02_luu.resize(grid.nxy);    d1_g02_luu.resize(grid.nxy);    d2_g02_luu.resize(grid.nxy);
    d0_g11_luu.resize(grid.nxy);    d1_g11_luu.resize(grid.nxy);    d2_g11_luu.resize(grid.nxy);
    d0_g12_luu.resize(grid.nxy);    d1_g12_luu.resize(grid.nxy);    d2_g12_luu.resize(grid.nxy);
    d0_g22_luu.resize(grid.nxy);    d1_g22_luu.resize(grid.nxy);    d2_g22_luu.resize(grid.nxy);
    // ADM Data:
    alpha.resize(grid.nxy);
    beta1_u.resize(grid.nxy);    beta1_l.resize(grid.nxy);
    beta2_u.resize(grid.nxy);    beta2_l.resize(grid.nxy);
    gamma11_ll.resize(grid.nxy);    gamma11_uu.resize(grid.nxy);
    gamma12_ll.resize(grid.nxy);    gamma12_uu.resize(grid.nxy);
    gamma22_ll.resize(grid.nxy);    gamma22_uu.resize(grid.nxy);
    d1_alpha_l.resize(grid.nxy);
    d2_alpha_l.resize(grid.nxy);
    d1_beta1_lu.resize(grid.nxy);    d1_beta2_lu.resize(grid.nxy);
    d2_beta1_lu.resize(grid.nxy);    d2_beta2_lu.resize(grid.nxy);
    d1_beta1_ll.resize(grid.nxy);    d1_beta2_ll.resize(grid.nxy);
    d2_beta1_ll.resize(grid.nxy);    d2_beta2_ll.resize(grid.nxy);
    d1_gamma11_lll.resize(grid.nxy);    d2_gamma11_lll.resize(grid.nxy);
    d1_gamma12_lll.resize(grid.nxy);    d2_gamma12_lll.resize(grid.nxy);
    d1_gamma22_lll.resize(grid.nxy);    d2_gamma22_lll.resize(grid.nxy);
    d1_gamma11_luu.resize(grid.nxy);    d2_gamma11_luu.resize(grid.nxy);
    d1_gamma12_luu.resize(grid.nxy);    d2_gamma12_luu.resize(grid.nxy);
    d1_gamma22_luu.resize(grid.nxy);    d2_gamma22_luu.resize(grid.nxy);
    K11_ll.resize(grid.nxy);
    K12_ll.resize(grid.nxy);
    K22_ll.resize(grid.nxy);
    // Tetrad Data:
    tetrad00_ul.resize(grid.nxy);    tetrad01_ul.resize(grid.nxy);    tetrad02_ul.resize(grid.nxy);
    tetrad10_ul.resize(grid.nxy);    tetrad11_ul.resize(grid.nxy);    tetrad12_ul.resize(grid.nxy);
    tetrad20_ul.resize(grid.nxy);    tetrad21_ul.resize(grid.nxy);    tetrad22_ul.resize(grid.nxy);
    tetrad00_lu.resize(grid.nxy);    tetrad01_lu.resize(grid.nxy);    tetrad02_lu.resize(grid.nxy);
    tetrad10_lu.resize(grid.nxy);    tetrad11_lu.resize(grid.nxy);    tetrad12_lu.resize(grid.nxy);
    tetrad20_lu.resize(grid.nxy);    tetrad21_lu.resize(grid.nxy);    tetrad22_lu.resize(grid.nxy);
}
...
void Metric::InitializeBoostedTetradOnGrid()
{
    ...
    for(size_t i=0; i<grid.nx; i++)
    {
        ...
        tetrad00_lu[ij]=inverseTetrad[{0,0}];    tetrad01_lu[ij] = inverseTetrad[{0,1}];  tetrad02_lu[ij] = inverseTetrad[{0,2}];
        tetrad10_lu[ij]=inverseTetrad[{1,0}];    tetrad11_lu[ij] = inverseTetrad[{1,1}];  tetrad12_lu[ij] = inverseTetrad[{1,2}];
        tetrad20_lu[ij]=inverseTetrad[{2,0}];    tetrad21_lu[ij] = inverseTetrad[{2,1}];  tetrad22_lu[ij] = inverseTetrad[{2,2}];
    }
}
...
Tensor3x3 Metric::GetTetrad(const Coord& xy)
{
    ...
    else
    {
        Coord ij = grid.ij(xy);
        return Tensor3x3
        (InterpolateArrayTo_ij(tetrad00_ul,ij), InterpolateArrayTo_ij(tetrad01_ul,ij), InterpolateArrayTo_ij(tetrad02_ul,ij),
...
{
    return Tensor3x3
    (tetrad00_lu[ij], tetrad01_lu[ij], tetrad02_lu[ij],
...
Tensor3x3 Metric::GetTetradInverse(const Coord& xy)
{
    ...
    else
    {
        Coord ij = grid.ij(xy);
        return Tensor3x3
        (InterpolateArrayTo_ij(tetrad00_lu,ij), InterpolateArrayTo_ij(tetrad01_lu,ij), InterpolateArrayTo_ij(tetrad02_lu,ij),
...
Tensor2x2 Metric::GetDerivBeta_lu(const Coord& xy)
{
    ...
    else
    {
        Coord ij = grid.ij(xy);
        return Tensor2x2
        (InterpolateArrayTo_ij(d1_beta1_lu,ij), InterpolateArrayTo_ij(d1_beta2_lu,ij),
...
Tensor2x2 Metric::GetDerivBeta_ll(const Coord& xy)
{
    ...
    else
    {
        Coord ij = grid.ij(xy);
        return Tensor2x2
        (InterpolateArrayTo_ij(d1_beta1_ll,ij), InterpolateArrayTo_ij(d1_beta2_ll,ij),
